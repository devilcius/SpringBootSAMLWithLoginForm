package net.technoage.springboot.saml.config;
...
import net.technoage.springboot.saml.service.CurrentUserDetailsService;
import net.technoage.springboot.saml.service.SAMLUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean
{
    ...
    {
        String idpMetadataURL = metadataUrl;
